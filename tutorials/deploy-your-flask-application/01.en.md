...
path: "/tutorials/run-your-flask-backend-on-a-server"
slug: "deploy-your-flask-application"
...
### Set up and deploy your very own Flask web application on Hetzner as systemctl service with Nginx
